...
class App extends Component {
  ...
  render() {
    ...
    return (
      <Wrapper>
        <Title>
          {/* <div style={headerDiv}>React Memory Game!</div><br></br>
          ...
          <div>
            ...
            <div style={rightStyle}>Your BEST result is {this.state.bestResult} from 9! </div>
            <div style={cenTer}>
              <div style={centerStyle}>Use the best of your memory! Click all pictures one by one only once and you win! They will shaffle every time you click a picture! Good luck!{":)"}</div>
